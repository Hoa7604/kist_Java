 ...
 * Generated at: 2020-08-14 05:02:05 UTC
...
public final class book_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  static {
    ...
    _jspx_imports_classes.add("tp.kits3.livedinner.io.Book");
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("\t<header style = \"position: initial;\">\r\n");
      out.write("\t\t<nav>\r\n");
      ...
      out.write("\t\t\t\t\t\t\t<div >\r\n");
      out.write("\t\t\t\t\t\t\t\t<div >\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<input type=\"text\" id=\"name\" name=\"name\" placeholder=\"\" required data-error=\"Please enter your name\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<div ></div>\r\n");
      out.write("\t\t\t\t\t\t\t\t</div>                                 \r\n");
      out.write("\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t<div >\r\n");
      out.write("\t\t\t\t\t\t\t\t<div >\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<input type=\"text\" placeholder=\"\" id=\"email\" name=\"name\" required data-error=\"Please enter your email\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<div ></div>\r\n");
      out.write("\t\t\t\t\t\t\t\t</div> \r\n");
      out.write("\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t<div >\r\n");
      out.write("\t\t\t\t\t\t\t\t<div >\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<select id=\"guest\" required data-error=\"Please Select Person\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t  <option disabled selected>Please Select Person*</option>\r\n");
      ...
      out.write("\t\t\t\t\t\t\t<div >\r\n");
      out.write("\t\t\t\t\t\t\t\t<div > \r\n");
      out.write("\t\t\t\t\t\t\t\t\t<textarea id=\"message\" placeholder=\"Your Message\" rows=\"4\" data-error=\"Write your message\" required></textarea>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<div ></div>\r\n");
      out.write("\t\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t<div >\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<button id=\"submit\" type=\"submit\">Send Message</button>\r\n");

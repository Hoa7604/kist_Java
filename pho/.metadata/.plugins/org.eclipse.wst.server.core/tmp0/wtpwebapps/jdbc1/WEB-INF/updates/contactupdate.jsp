...
<%@ page language="java" contentType="text/html; charset=UTF-8"
    ...
    <%
    	...
    	contact = (Contact) request.getAttribute("ContactFind");
						...
						<div class="wrap-sub-form">
							<div class="wrap wrap-user">
								<div class=" box user-box">
									Usename: 
									<input type="text" id="name" name="name" value="<%= %>"  placeholder="Your Name" required data-error="Please enter your name">
									<div ></div>
								</div>                                 
							</div>

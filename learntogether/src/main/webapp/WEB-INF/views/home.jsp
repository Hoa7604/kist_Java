...
<body>
	<header>
        <!-- Header Start -->
        <div class="header-area header-transparent" style="background-color: #f00";>
                                        ...
                                        <nav>
                                            <ul id="navigation">                                                                                          
                                                ...
                                                <li><a href="/learntogether/courses">Courses</a>
                                                    <ul class="submenu">
                                                        <li><a href="blog.html">Language</a>
                                                            <ul>
                                                                <li>Korea</li>
                                                                <li>English</li>
                                                            </ul>
                                                        ...
                                                        <li><a href="blog_details.html">Developper</a>
                                                            <ul>
                                                                <li>Html-Css</li>
                                                                <li>react</li>
                                                            </ul>
                                                ...
                                                <div class="cart-header">
                                                    <a href="/learntogether/cart"><i class="fa fa-shopping-cart" aria-hidden="true"></i></a>
                                                </div>  
            ...
            <div class="container">
                ...
                <div class="courses-actives">
                    ...
                    <c:forEach var="listCs" items="${ListCourses}">
                    	<c:url value="/cart" var="addcart">
                    		<c:param name="idcourse" value="${listCs.id}"></c:param>
                    	</c:url>  
                    	<div class="col-md-3 properties pb-20">
                        <div class="properties__card">
                            <div class="properties__img overlay1">
                                <a href="#"><img src="resources/assets/img/gallery/featured1.png" alt=""></a>
                            </div>
                            <div class="properties__caption">
                                <p>User Experience</p>
                                <h3><a href="#">${listCs.courseTitle}</a></h3>
                                <p>${listCs.description}</p>
                                <div class="properties__footer d-flex justify-content-between align-items-center">
                                    ...
                                    <div class="price">
                                        <span>${listCs.priceCourse}</span>
                                    </div>
                                </div>
                                <a href="${addcart}" class="border-btn border-btn2">Add to card</a>
                            </div>
            ...
            <div class="container">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-3 col-md-4 col-sm-6">
                        <div class="single-topic text-center mb-30">
                            <div class="topic-img">
                                <img src="resources/assets/img/gallery/topic2.png" alt="">
                                <div class="topic-content-box">
                                    <div class="topic-content">
                                        <h3><a href="#">Programing</a></h3>
                                    </div>
                    ...
                    <div class="col-lg-3 col-md-4 col-sm-6">
                        <div class="single-topic text-center mb-30">
                            <div class="topic-img">
                                <img src="resources/assets/img/gallery/topic3.png" alt="">
                                <div class="topic-content-box">
                                    <div class="topic-content">
                                        <h3><a href="#">Programing</a></h3>
                                    </div>
                    ...
                    <div class="col-lg-3 col-md-4 col-sm-6">
                        <div class="single-topic text-center mb-30">
                            <div class="topic-img">
                                <img src="resources/assets/img/gallery/topic4.png" alt="">
                                <div class="topic-content-box">
                                    <div class="topic-content">
                                        <h3><a href="#">Programing</a></h3>
                                    </div>
                    ...
                    <div class="col-lg-3 col-md-4 col-sm-6">
                        <div class="single-topic text-center mb-30">
                            <div class="topic-img">
                                <img src="resources/assets/img/gallery/topic5.png" alt="">
                                <div class="topic-content-box">
                                    <div class="topic-content">
                                        <h3><a href="#">Programing</a></h3>
                                    </div>
                    ...
                    <div class="col-lg-3 col-md-4 col-sm-6">
                        <div class="single-topic text-center mb-30">
                            <div class="topic-img">
                                <img src="resources/assets/img/gallery/topic6.png" alt="">
                                <div class="topic-content-box">
                                    <div class="topic-content">
                                        <h3><a href="#">Programing</a></h3>
                                    </div>
                    ...
                    <div class="col-lg-3 col-md-4 col-sm-6">
                        <div class="single-topic text-center mb-30">
                            <div class="topic-img">
                                <img src="resources/assets/img/gallery/topic7.png" alt="">
                                <div class="topic-content-box">
                                    <div class="topic-content">
                                        <h3><a href="#">Programing</a></h3>
                                    </div>
                    ...
                    <div class="col-lg-3 col-md-4 col-sm-6">
                        <div class="single-topic text-center mb-30">
                            <div class="topic-img">
                                <img src="resources/assets/img/gallery/topic8.png" alt="">
                                <div class="topic-content-box">
                                    <div class="topic-content">
                                        <h3><a href="#">Programing</a></h3>
                                    </div>
